...
<div class="panel">
    ...
    <form id="editForm" action="${pageContext.request.contextPath}/controller" method="post"
        ...
        <div class="datetime">
            ...
            <input type="time" name="duration" min="01:00:00" max="3:00:00" value="${film.getDuration()}" required>
        </div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/script/filmEditingDates.js"></script>
</body>
</html>
